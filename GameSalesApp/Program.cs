...
using GameSalesApp.Adapters;
using GameSalesApp.Concrete;
...
namespace GameSalesApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            gameManager.DeleteGame(new Game { GameId = 13, GameName = "Rocket League", GamePrice = "30₺" });
